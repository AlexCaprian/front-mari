    ...
    showDialog(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            const Text(
              'Guarde em um lugar seguro. Sem ele você não consegue mais acessar sua conta em outro aparelho.',
            ),
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // 4. Botão Fazer backup automático
                AppButton(
