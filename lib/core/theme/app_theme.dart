...
class AppTheme {
  /// Família tipográfica da aplicação, declarada em `pubspec.yaml`
  /// (assets/font/PlusJakartaSans-*.ttf).
  ...
  static ThemeData get lightTheme {
    ...
    return ThemeData(
      ...
      // Tipografia (Plus Jakarta Sans) com cor preta de alto contraste forçada em todas as variantes
