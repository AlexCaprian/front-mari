...
class AppTextField extends StatelessWidget {
  ...
  /// Dicas de preenchimento automático (ex.: [AutofillHints.password]) para o
  /// gerenciador de senhas do sistema (Google Password Manager no Android,
  /// Keychain no iOS). Precisa de um [AutofillGroup] acima na árvore.
